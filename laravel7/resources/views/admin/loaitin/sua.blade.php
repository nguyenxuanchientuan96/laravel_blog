                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Loai Tin
                            <small>Sua Loai Tin:  {{$ltin->Ten}}</small>
                        </h1>
                    </div>
                    <!-- /.col-lg-12 -->
                    @if(count($errors) > 0)
                    ...
                    <div class="col-lg-7" style="padding-bottom:120px">
                        <form action="{{route('loaitin.update',$ltin->id)}}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="Ten" placeholder="Nhap ten the loai" value="{{$ltin->Ten}}" />
                            </div>
